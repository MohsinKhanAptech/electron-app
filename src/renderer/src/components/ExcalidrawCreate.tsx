...
function ExcalidrawCreate({ updateHideExcalidrawCreate }): JSX.Element {
  ...
  const hideDrawingCreate = (): void => {
    updateHideExcalidrawCreate(true)
  }

  // handle submit i.e create dir and hide the dir create element
  const handleSubmit = (event: FormEvent): void => {
    event.preventDefault()
    window.context.createDrawing(fileName)
    hideDrawingCreate()
  }
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xl">Select Drawing Name</p>
        <p className="">
...
export default ExcalidrawCreate
